...
<head>
    <meta charset="utf-8">
    <title>Resin Art-products</title>
    ...
    <div class="container-xxl py-5">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                        <?php
						    $pcid=$_GET['pcid'];
							$stmt=$admin->ret("SELECT * FROM `product` WHERE `pc_id`='$pcid' AND `p_status`='ACTIVE'");
		...
		<div class="col-12 text-center">
            ...
            <div class="row">
				...
				<br><br>
                <?php 
				     $stmt=$admin->ret("SELECT * FROM `service` WHERE `pc_id`='$pcid' AND `s_status`='ACTIVE'");
                     while( $row=$stmt->fetch(PDO::FETCH_ASSOC)){ ?>
            ...
            <div class="row" >
                ...
                <div class="col-lg-4 col-md-6 col-custom" >
                    <div class="contact-info-item"  >
                        ...
                        <div class="con-info-txt">
                            <h6>date :<?php echo $row['f_date']?></h6>
