                        ...
                        ?>
                            <table class="table">
                                ...
                                <tr class="cart_item">
                                        ...
                                        <td class="cart-product-total text-center"><span class="amount"><?php echo $row['p_name']?> <small></small></span></td>
                                    </tr>
                                    <tr class="cart_item">
                                        <td class="cart-product-name"> Price<strong class="product-quantity">
                                </strong></td>
                                        <td class="cart-product-total text-center"><span class="amount"><?php echo $price?> <small></small></span></td>
                                    </tr>
                                    <tr class="cart_item">
                                        <td class="cart-product-name"> Quantity<strong class="product-quantity">
                                </strong></td>
                                        <td class="cart-product-total text-center"><span class="amount"><?php echo $row['cr_quantity']?></span></td>
                                    </tr>
                                </tbody>
                                <tfoot>
