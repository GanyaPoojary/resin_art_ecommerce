...
<head>
    <meta charset="utf-8">
    <title>Resin Art-Seller's Camp</title>
...
<body>
    ...
    <!-- History Area Start Here -->
					...
					<div class="vh-100" style="background-image:url('images/ss.jpg');">
    <div class="container py-5 h-100" >
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col">
          <?php
          $stmt2 = $admin->ret("SELECT * FROM `order` INNER JOIN `product` ON order.p_id=product.p_id WHERE `c_id`='$cid' ORDER BY order.or_id DESC");
          $c=$stmt2->rowCount();          
            ...
            <div class="card card-stepper mt-2" style="border-radius: 10px;">
              ...
              <div class="card-body p-4">
                ...
                ?>
                   ...
                   <a href="feedback.php?orid=<?php echo $row['or_id']?>&pcid=<?php echo $row['pc_id']?>" class="btn btn-info">Feedback</a>
                <?php } ?>
              </div>
