                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-custom" width="200px;">
                                            <form action="controller/feedback.php" class="comment-form-area" method="post">
												<br><br><br><br><br>
                                                <center>
                                                <h1 style="color:blue">Thank You For Ordering</h1>
                                                <p align="center" style="width:50ch;">Thank you for placing your order with us. We truly appreciate your business and the trust you have placed in our company. Your satisfaction is our top priority, and we are committed to ensuring that your order is handled with the utmost care and attention to detail.
</p><p align="center" style="width:70ch;">We want to assure you that we are working diligently to process your order as quickly as possible. Our dedicated team is carefully preparing your items for shipment, ensuring that they are packaged securely to reach you in perfect condition.</p>
</center>
