                ...
                <div class="col-md-6 col-custom">
                    <div class="collection-content">
                        <div class="section-title text-left">
                            ...
                            <h3 class="section-title-3 pb-0">Welcome to world of Resin </h3>
                        </div>
                        <div class="desc-content">
                            <p>Welcome to the enchanting world of Resin Art, where creativity meets innovation. Explore our stunning collection of handmade resin art pieces, crafted with precision and passion. From vibrant colors to intricate textures, our art pieces will transform your space into a masterpiece.</p><br>
                        </div>
                ...
                <div class="col-md-6 col-custom">
                    ...
                    <div class="single-banner hover-style">
                        <div class="banner-img">
                            <a href="#">
                                <img src="img/a8.jpg" alt="About Image">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-custom order-2 order-md-1">
                    ...
                    <div class="single-banner hover-style">
                        <div class="banner-img">
                            <a href="#">
                                <img src="img/img27.jpg" alt="About Image">
                                <div class="overlay-1"></div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-custom order-1 order-md-2">
                    <div class="collection-content">
                        <div class="section-title text-left">
                            ...
                            <h3 class="section-title-3 pb-0">A Gift of Love</h3>
                        </div>
                        <div class="desc-content">
                            <p>Resin Art is more than just a piece of art - it's a gift of love. Each handmade piece is crafted with precision, passion, and dedication. Our resin art pieces make perfect gifts for loved ones, friends, and family, spreading joy and warmth. Give a gift that comes from the heart.</p>
                        </div>
            ...
            <div class="row mb-30 align-items-center">
                <div class="col-md-6 col-custom">
                    <div class="collection-content">
                        ...
                        <div class="desc-content">
                            <p>Love is at the heart of every Resin Art piece. Our artist carefully craft each item with passion, dedication, and attention to detail. We believe that art should bring joy and warmth to your life, which is why we pour our hearts into every resin art piece. Explore our collection and discover the love and care that goes into each unique masterpiece.</p><br>
                        </div>
                ...
                <div class="col-md-6 col-custom">
                    ...
                    <div class="single-banner hover-style">
                        <div class="banner-img">
                            <a href="#">
                                <img src="img/f5.jpg" alt="About Image">
                                <div class="overlay-1"></div>
                            </a>
                        </div>
                    </div>
