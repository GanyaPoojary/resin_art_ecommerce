    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="top-bar row gx-0 align-items-center d-none d-lg-flex">
            <div class="col-lg-6 px-5 text-start">
                ...
                <small class="ms-4"><i class="fa fa-envelope me-2"></i>info@ResinArt.com</small>
            </div>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="admin/signin.php" class="dropdown-item">Admin</a>
                            <!-- <a href="seller/login.php" class="dropdown-item">Seller Page</a> -->
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/f2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="col-lg-7">
                                    
                                    <h1 class="display-2 mb-5 animated slideInDown">Handcrafted with Love</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="col-lg-7">
                                    <h1 class="display-2 mb-5 animated slideInDown">Unique blends, endless possibilities</h1>
                                    <a href="login.php" class="btn btn-primary rounded-pill py-sm-3 px-sm-5">Products</a>
                                    <a href="aboutus.php" class="btn btn-secondary rounded-pill py-sm-3 px-sm-5 ms-3">About Us</a>
                                </div>
                            </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="col-lg-7">
                                    <h1 class="display-2 mb-5 animated slideInDown">Emotions frozen in time, with every resin piece</h1>
...
<div class="row">
    <div class="video-con">
         <video src="img/v4.mp4" loop autoplay muted></video>
         <h3>Best Resin</h3>
    </div>
    <div class="content">
         <h3>Resin with Love </h3>
         <p>Our resin art pieces are more than just visually stunning creations. They're made with love, care, and a deep passion for the craft. Every layer of resin is applied with intention, every color is chosen with thoughtfulness, and every piece is infused with a sense of joy and wonder.
         </p>
    </div>
...
<div class="row" id="row2">
    <div class="video-con">
         <video src="img/v6.mp4" loop autoplay muted></video>
         <h3>Artist</h3>
    </div>
    <div class="content">
         <h3>Artist</h3>
         <p>At Resin Art, I passionate about creating resin art that inspires and connects with others. I believe in the power of art to transform and uplift, and are committed to creating unique, handmade pieces that capture the beauty of emotions.</p>
    </div>
...
<div class="row">
    <div class="video-con">
         <video src="img/v7.mp4" loop autoplay muted></video>
         <h3>Quality materials</h3>
    </div>
    <div class="content">
         <h3>Quality</h3>
         <p>Quality is not just about creating perfect pieces; it's about creating pieces that inspire, uplift, and bring joy to those who experience them. It's about attention to detail, creativity, and passion. It's about taking the time to get it right, and being committed to excellence in everything i do.</p>
    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-item" style="">
                                ...
                                <div class="text-center p-4">
                                    <a class="d-block h5 mb-2" href=""><?php echo $row['p_name'];$i++; ?></a>
