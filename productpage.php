            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-custom">
                    <div class="product-summery position-relative">
                        ...
                        <p class="desc-content mb-5" style="max-width:40ch"><?php echo $row['p_desc'] ?></p>
                          <div class="quantity-with_btn mb-5" id="ajax_table">
                           <!--   <div class="quantity">
                            ...
                            <?php
                                 $cid=$_SESSION['c_id'];
        	                     $stmt4=$admin->ret("SELECT COUNT(*) FROM `cart` WHERE `p_id`='$pid' AND `c_id`='$cid'");
                                 $row4=$stmt4->fetch(PDO::FETCH_ASSOC);
                                 $qty=implode($row4);
                ...
                <div class="col-lg-12 col-custom">
                    ...
                    <div class="tab-content mb-text" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="connect-3" role="tabpanel" aria-labelledby="contact-tab">
                            ...
                            <?php
						    $stmt2=$admin->ret("SELECT * FROM `service` WHERE `pc_id`='$pcid' AND `s_status`='ACTIVE'");
                        ...
                        ?>
                                ...
                                <table class="table border">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="cun-name">State : <?php echo $row1['pc_state']?></td>
                                            
                                          
                                        </tr>
                                        <tr>
                                                 <td>See More: <a href="sellerproduct.php?pcid=<?php echo $pcid?>">More Details</a></td>
                                        </tr>
